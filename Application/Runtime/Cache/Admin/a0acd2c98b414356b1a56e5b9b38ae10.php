	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					<li>
						<i class="fa fa-dashboard"></i>  <a href="/admin.php?c=positioncontent">Position Content</a>
					</li>
					<li class="active">
			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="url" id="inputPassword3" placeholder="url">
						</div>
					</div>
					<div class="form-group">
						<label for="inputname" class="col-sm-2 control-label">Article Id:</label>
						<div class="col-sm-5">
							<input type="text" name="news_id" class="form-control" id="inputname" placeholder="can be empty if not releated to a article">
						</div>
					</div>
					<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">Status:</label>
					<div class="col-sm-5">
						<input type="radio" name="status" id="optionsRadiosInline1" value="1" checked> Open
						<input type="radio" name="status" id="optionsRadiosInline2" value="0"> Close
					</div>

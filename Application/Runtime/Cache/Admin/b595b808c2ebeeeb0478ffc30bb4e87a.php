        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    Hello!Welcone to use singcms content management platform
                </h1>
                <ol class="breadcrumb">
                    <li class="active">
                        <i class="fa fa-dashboard"></i> Platform Overview
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="panel panel-red">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge"><?php echo ($position); ?></div>
                                <div>Promotion Position Number</div>
                            </div>
                        </div>
                    </div>

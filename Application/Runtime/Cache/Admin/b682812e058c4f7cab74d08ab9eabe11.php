                    ...
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <tbody>
                            <?php if(is_array($admins)): $i = 0; $__LIST__ = $admins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>    
                                <a href="javascript:void(0)" attr-id="<?php echo ($admin["admin_id"]); ?>" id="singcms-delete"  attr-a="admin" attr-message="Delete"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a></td>

            ...
            <form action="/admin.php" method="get">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control" name="type">
                        ...
                        <option value="1" <?php if($type == 1): ?>selected = "selected"<?php endif; ?>>Back-End</option>
                        <option value="0" <?php if($type == 0): ?>selected = "selected"<?php endif; ?>>Front-End</option>
                    <lect>
                </div>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><span class="glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($menu["menu_id"]); ?>"></span>    <a attr-id="<?php echo ($menu["menu_id"]); ?>" id="singcms-delete"  attr-a="menu" attr-message="删除"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a></td>

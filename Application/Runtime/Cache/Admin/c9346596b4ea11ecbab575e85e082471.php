            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="copyfrom">
                    <?php if(is_array($copyFrom)): foreach($copyFrom as $key=>$source): ?><option value="<?php echo ($key); ?>" <?php if($key == $news['copyFrom']): ?>selected="selected"<?php endif; ?>><?php echo ($source); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
